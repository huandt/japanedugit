...
class category_mod extends Module {
    ...
    function submit(){        
        ...
        if($imageName){
            ...
            $config['upload_path']      = STORE_DATA.'categories';
    ...
    function draw($params=array()){        
        ...
        $assign = array(
            ...
            'begin_form'  => form_open('backend/category_mod', '',array('enctype'=>'multipart/form-data'),array('class'=>'form-horizontal')),
