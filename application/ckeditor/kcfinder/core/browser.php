...
class browser extends uploader {
	...
	function CheckAuthentication()
	{
		...
		return true;
		return isset($_SESSION['LetVNuserinfo']) && $_SESSION['LetVNuserinfo']['login_form_system'];
	}
    ...
    public function action() {
        ...
        if ($this->config['disabled'] || !$this->CheckAuthentication()) {
            $message = $this->label("Bạn không đủ quyền hạn để truy cập khu vực này.");
